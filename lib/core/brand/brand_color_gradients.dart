...
class BrandGradients {
  ...
  static List<Color> brandGradient = [const Color(0xffad01ff), const Color(0xffff83f2)];
  static List<Color> brandGradientSecondary = [const Color(0xffad01ff), const Color(0xffff01e5)];
